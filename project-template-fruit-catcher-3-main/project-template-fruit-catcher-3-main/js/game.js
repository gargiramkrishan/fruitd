class Game{
    ...
    play(){
                ...
                if (keyIsDown(LEFT_ARROW) && player.index !== null) {
                 ...
                 if(frameCount % 40 === 0)
                 {
                    obstacle = createSprite(random(100,1000),0,100,999)
                    obstacle.velocityY = 10;
                    var rand2 = Math.round(random(1,2))
                    switch(rand2)
                    {
                        case 1: obstacle.addImage("obstacle1",obstacleImage);
                        case 2:obstacle.addImage("obstacle1", obstacle2Image);
                        break;
                    }
                    obstacle.scale = 0.1
                  ...
                  if (player.index !== null) {
                      ...
                      {
                        if(obstacleGroup.get(i).isTouching(player2))
                        {
